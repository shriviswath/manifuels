...
| `003_realtime.sql` | `REPLICA IDENTITY FULL` **and** publication membership | Apply last |
| `004_rls_and_auth.sql.pending` | RLS, Supabase Auth, `station_id` | **Do not apply yet** — see below |
...
Rename it to `004_rls_and_auth.sql` and apply it in the same release as the
