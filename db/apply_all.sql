-- ═══════════════════════════════════════════════════════════════════
-- ManiFuels — apply_all.sql   (v2.3)
--
-- Migrations 001–007 in order. Your base schema already exists and is NOT
-- recreated here.
--
...
-- ═══════════════════════════════════════════════════════════════════
-- Verify:
--   select user_id, opening_msd, opening_hsd from app_settings;  -- not zeros
--   select column_name from information_schema.columns
--   where table_name='staff' and column_name='salary_history';   -- 1 row
-- ═══════════════════════════════════════════════════════════════════
