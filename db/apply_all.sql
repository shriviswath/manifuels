-- ═══════════════════════════════════════════════════════════════════
-- ManiFuels — apply_all.sql   (v2.4)
--
-- Migrations 001–008 in order. Your base schema already exists and is NOT
-- recreated here.
--
...
--   client release that sets MF_STATION — one without the other hides the data
--   until both are in place. Take a backup first.
--
