...
Run manifuels_schema.sql followed by manifuels_migration_v2.5.sql in the SQL Editor

2. Update credentials in index.html
javascriptvar SUPABASE_URL = 'https://your-project.supabase.co';
var SUPABASE_ANON_KEY = 'your-anon-key';
3. Add your users
sqlINSERT INTO users (username, display_name, password_hash, role)
VALUES ('yourname', 'Your Name', '<sha256_of_password>', 'owner');
4. Deploy

Upload index.html to Cloudflare Pages as a direct upload
Live at yoursite.pages.dev — no server required
