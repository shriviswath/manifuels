-- ═══════════════════════════════════════════════════════════════════
-- ManiFuels — apply_all.sql   (v2.1)
--
-- Migrations 001–003 in order. Your base schema already exists and is NOT
-- recreated here; this only adds what the v2.1 client needs and repairs the
-- realtime setup.
--
...
-- Expected result: "Success. No rows returned" plus a few NOTICE lines.
-- ═══════════════════════════════════════════════════════════════════
...
--   where pubname='supabase_realtime' order by 1;   -- expect ~17
-- ═══════════════════════════════════════════════════════════════════
